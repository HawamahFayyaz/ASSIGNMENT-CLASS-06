      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-5xl mx-auto">
          <div className="text-sm mb-4 bg-white px-4 py-2 rounded-lg shadow-sm">
            ...
            <span className="mx-2 text-gray-500">{">"}</span>
            <span className="text-gray-800 font-medium">Honda City</span>
          </div>
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300 mb-8">
            <h2 className="text-2xl font-bold mb-4 text-gray-900">
              About Honda City 2024
            </h2>
            <p className="text-gray-700 leading-relaxed">
              The new Honda City has a bold design. Its front is embellished
              with a honeycomb grille which gives it a striking appearance.
              Premium dual-barrel halogen headlamps and integrated LED daytime
              running lights (DRLs) adorn the front of all five variants. The
              1.5 Aspire variants come with front fog lights while it is an
              option in the rest of the variants.
            </p>
          </div>
